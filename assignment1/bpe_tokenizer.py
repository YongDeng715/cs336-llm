...
class BPETokenizer:
    ...
    def get_stats(token_lists):
        """统计所有 token_lists (list of list of tokens) 中相邻 pair 的出现频率"""
        pairs = Counter()
    ...
    @classmethod
    def train(cls, corpus, vocab_size=1000, min_frequency=2):
        """
        corpus: list of strings (e.g. words or whitespace-separated text)
        vocab_size: 目标 vocab 大小 (包括基础 tokens + 合并后的 subwords)
...
if __name__ == "__main__":
    ...
    tokenizer = BPETokenizer.train(corpus, vocab_size=50, min_frequency=2)
